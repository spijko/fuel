...
<div class="row padded">
	...
	<section class="panel-body row">
		<figure class="col-xs-12 col-sm-5 col-md-6">
			<img alt="" src="/fuel/assets/images/Jellyfish.jpg">
		</figure>
		<div class="col-xs-12 col-sm-7 col-md-6">
			<h1>Title</h1>
			<h4>Wednesday, September 10, 2014, 12 am PDT</h4>
			<p>Derecti distinxit induit tuti tollere
Locis figuras mentes nulli? Semina fert principio. Semina lanient quanto formaeque! Duae evolvit coegit dissociata spisso imagine montibus. Chaos: media quanto caelo aere carentem levius diffundi. Neu homini numero undae cognati illic dominari instabilis?

Nulli derecti mixta formaeque nova
Tenent caecoque lacusque vesper subsidere
Toto non nuper sibi cognati
Metusque cesserunt. Minantia regat volucres contraria! Tepescunt nullo omni fuerat emicuit. Ita vultus ventos natus. Vesper rerum pondere egens possedit flexi posset: opifex homo? Verba altae nova mundo spectent toto traxit. Undae fuit locis deerat altae fuit aequalis lege terrae.

Aetas limitibus lapidosos sole onus chaos: magni duas aeris dei conversa caelumque sidera habitabilis cingebant peragebant
Iapeto nubes caecoque litora ponderibus sidera faecis diversa permisit pondere fuit vultus sinistra praeter effervescere nulli dominari cingebant tollere aestu sectamque
Nuper manebat ponderibus supplex nec pondere habitandae usu vos inter nubes
Metusque siccis innabilis diffundi habendum divino quin calidis carentem lacusque mortales quin ponderibus deus flamina figuras aere
Turba cognati effigiem membra terras sanctius lapidosos montibus habitandae usu onus verba ardentior caesa lege lumina
Carmen corpore eodem pendebat nisi sidera septemque nullaque sublime sinistra dixere nullus non discordia igni carentem tuti poena pondus peregrinum
Aequalis habitandae nabataeaque orba fidem. Scythiam ita militis ambitae praecipites aestu persidaque foret. Ignea volucres radiis adspirate fulminibus alto obliquis. Iudicis frigida fossae. Aequalis emicuit formaeque circumdare circumfuso aliud contraria onus nunc.

Est aequalis habitabilis circumfuso limitibus bracchia proximus posset: undis aurea possedit vultus animalia viseret liquidas orbis circumfluus madescit
Ne animus numero terrarum spisso quem fossae diu invasit pinus frigore ut ante inclusum
Imagine aberant aethere mundi utramque recens animalia modo numero grandia aestu orba
Nullaque tollere caelum principio ripis secrevit mundi ille invasit arce regat unda flamina tellus ignotas quae
Erat inposuit tanta proximus humanas fecit deerat lacusque sublime. Caelumque locavit exemit dissociata lucis iudicis iners quin reparabat. Temperiemque flamma quod os. Terra cuncta pressa quia extendi. Est indigestaque eodem ipsa inminet ne duae mare alto! Volucres ultima metusque exemit locum!</p>
			<div class="btn-cage">
								<a href="" class="btn btn-lg btn-community" data-not-on-prod-class-change="">Learn More</a><button type="button" class="btn btn-lg btn-primary" data-toggle="modal" data-target="#reserve-tickets-modal">Reserve Tickets</button>
			</div>
		</div>
	</section>
</article>
...
<div class="row padded">
  <article class="panel panel-default col-xs-12 rounded-bottom-footer shadow-both">
      ...
      <div class="col-xs-12 col-sm-4">
        <figure class="bordered-img-container shadow-left"> <img alt="" src="/fuel/assets/images/me.jpg" srcset="http://placehold.it/640x480 2x"> </figure>
      </div>
      <div class="col-xs-12 col-sm-8">
        <h2>
          test event 1        </h2>
        <h4><strong>Subtitle</strong>
          Monday, September 29, 2014, 12 am PDT        </h4>
        <p>
          ASDSADasdasdasd        </p>
        <div class="btn-cage"> <a href="" class="btn btn-lg btn-community" data-not-on-prod-class-change="">Learn More</a><a href="#" class="btn btn-lg btn-primary">Get Tickets</a> </div>
      </div>
    </section>
    <hr class="row">
...
Vindice humanas media flexi stagna altae indigestaque undas siccis. Tumescere deerat eodem neu fecit recessit seductaque locis rudis. Orba vix. Spectent tellure. Erat: onerosior undis levitate quicquam parte elementaque. Terrae boreas secant? Ardentior foret natus opifex. Tumescere quisquis ora cum cingebant altae altae.</p>
        <div class="btn-cage"> <a href="home" class="btn btn-lg btn-community" data-not-on-prod-class-change="">Learn More</a><a href="#" class="btn btn-lg btn-primary">Get Tickets</a> </div>
      </div>
    </section>
        <hr class="row">
  </article>
