		...
		<article class="panel panel-default static-callout shadow-both">
			<header class="panel-header alpha-img-header">
				<figure class="alpha-img">
					<div class="cover-container">
						<img alt="community" src="me.jpg" srcset="//placehold.it/1340x260 2x">
					</div>
				</figure>
			</header>
			<section class="panel-body">
				...
				<p>sadasdasdasdasdsa</p>
								<a href="<?php echo img_path('google.com');?>" class="btn btn-lg btn-community" data-not-on-prod-class-change="">View Events</a>
			</section>
		</article>
	</div>
	<div class="col-xs-12 col-sm-6">
		<article class="panel panel-default static-callout shadow-both">
			<header class="panel-header alpha-img-header">
				<figure class="alpha-img">
					<div class="cover-container">
						<img alt="community" src="survey.jpg" srcset="//placehold.it/1370x260 2x">
					</div>
				</figure>
			</header>
			<section class="panel-body">
