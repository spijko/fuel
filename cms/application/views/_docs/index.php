<?php /*?><h1>Site Documentation for <?=$this->config->item('site_name', 'fuel')?></h1>
<p>The following contains documentation regarding your CMS website. This site is running CMS <?=FUEL_VERSION?>. Additional FUEL documentation can be found at <a href="http://docs.getfuelcms.com" target="_blank">docs.getfuelcms.com</a>.</p>
<ul>
...
<p>The dashboard displays the latest activity within the system, FUEL news as well as a link to this documentation. </p>
...
<p>More can be read about creating pages and variables in the <a href="http://docs.getfuelcms.com/general/pages-variables" target="_blank"> User Guide</a>.</p>
