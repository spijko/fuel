...
class Promotions_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Promotion'; // the name of the record class (if it can't be determined)
	public $filters = array(); // filters to apply to when searching for items
	public $required = array('name'=>'name is required','content'=>'content is required','promotion_date'=>'promotion date is required','promotion_date_end'=>'promotion end date is required','promotion_image'=>'promotion image is required','promotion_image_link'=>'promotion image link is required'); // an array of required fields. If a key => val is provided, the key is name of the field and the value is the error message to display
	...
	{
		parent::__construct('promotions'); // table name
	}
...
class Promotion_model extends Base_module_record {
