...
class Partners_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Partner'; // the name of the record class (if it can't be determined)
	public $filters = array(); // filters to apply to when searching for items
	public $required = array('partner_image'=>'partner image is required','partner_url'=>'partner url is required','partner_title'=>'partner title is required','partner_text'=>'partner text is required'); // an array of required fields. If a key => val is provided, the key is name of the field and the value is the error message to display
	...
	{
		parent::__construct('partners'); // table name
	}
...
class Partner_model extends Base_module_record {
