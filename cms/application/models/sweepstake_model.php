...
class Sweepstake_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Sweepstake_item'; // the name of the record class (if it can't be determined)
	public $filters = array(); // filters to apply to when searching for items
	public $required = array('name'=>'name is required','content'=>'content is required','image'=>'image is required'); // an array of required fields. If a key => val is provided, the key is name of the field and the value is the error message to display
	...
	{
		parent::__construct('sweepstake'); // table name
	}
...
class Sweepstake_item_model extends Base_module_record {
