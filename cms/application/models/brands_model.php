...
class Brands_model extends Base_module_model {
	...
	public $record_class = 'Brand'; // the name of the record class (if it can't be determined)
	...
	{
		parent::__construct('brands'); // table name
	}
...
class Brand_model extends Base_module_record {
