...
class Clubs_model extends Base_module_model {

	// read more about models in the user guide to get a list of all properties. Below is a subset of the most common:

	public $record_class = 'Club'; // the name of the record class (if it can't be determined)
	public $filters = array(); // filters to apply to when searching for items
	public $required = array('club_image'=>'club image is required','club_title'=>'club title is required','clubt_text'=>'clubt text  is required','savings_info'=>'savings info is required'); // an array of required fields. If a key => val is provided, the key is name of the field and the value is the error message to display
	...
	{
		parent::__construct('clubs'); // table name
	}
...
class Club_model extends Base_module_record {
